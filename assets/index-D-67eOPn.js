...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function pm(e,t,n){let r=new Float32Array($p),i=new J(0,1,0);return new Uf({name:`SphericalGaussianBlur`,defines:{n:$p,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:gm(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function mm(){return new Uf({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:gm(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function hm(){return new Uf({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:gm(),fragmentShader:`
	...
	`}var _m=class extends ql{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1};this.texture=new kf([n,n,n,n,n,n]),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}var Hh={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function Uh(e,t){let n=Hh[t];return n===void 0?(W(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var Wh=new J;function Gh(){return X.getLuminanceCoefficients(Wh),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${Wh.x.toFixed(4)}, ${Wh.y.toFixed(4)}, ${Wh.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
...
void main() {
    ...
    `,transparent:!0,depthWrite:!1,blending:2})}createStarsMesh(){this.starsPoints&&(this.scene.remove(this.starsPoints),this.starsGeometry?.dispose()),this.starsGeometry=new Ed;let e=new Float32Array(this.starsData.length*3),t=new Float32Array(this.starsData.length);for(let e=0;e<this.starsData.length;e++)t[e]=this.starsData[e].mag;this.starsGeometry.setAttribute(`position`,new dd(e,3)),this.starsGeometry.setAttribute(`magnitude`,new dd(t,1)),this.starsPoints=new Df(this.starsGeometry,this.starsMaterial),this.starsPoints.renderOrder=20,this.scene.add(this.starsPoints)}updateUniforms(e,t){this.starsMaterial&&(this.starsMaterial.uniforms.fov.value=e,this.starsMaterial.uniforms.aspect.value=t)}update(e,t,n){if(!this.starsGeometry||this.starsData.length===0)return;let r=this.starsGeometry.attributes.position.array,i=1e3;for(let a=0;a<this.starsData.length;a++){let o=this.starsData[a],{az:s,alt:c}=q_(o.ra,o.dec,e,t,n),l=c*Math.PI/180,u=s*Math.PI/180,d=i*Math.sin(l),f=-i*Math.cos(l)*Math.cos(u),p=i*Math.cos(l)*Math.sin(u);r[a*3]=p,r[a*3+1]=d,r[a*3+2]=f}this.starsGeometry.attributes.position.needsUpdate=!0}dispose(){this.starsPoints&&this.scene.remove(this.starsPoints),this.starsGeometry?.dispose(),this.starsMaterial?.dispose()}},tv={azimuthalGrid:!1,equatorialGrid:!0,landscape:!0,cardinalDirections:!0,constellationLines:!0,constellationLabels:!0,constellationBoundaries:!1,skymap:!0},nv=class{scene;camera;renderer;cameraController;starLayer;gridLayer;landscapeLayer;cardinalDirectionLayer;constellationBoundaryLayer;constellationLayer;skymapLayer;observer={lat:37.5665,lon:126.978};time=new Date;layerVisibility={...tv};animationFrameId=null;constructor(e,t,n={}){this.scene=new Mu,this.scene.background=null,this.camera=new bp(185,e.clientWidth/e.clientHeight,.1,2e3),this.camera.position.set(0,0,0),this.renderer=new e_({canvas:e,antialias:!0,alpha:!0}),this.renderer.setSize(e.clientWidth,e.clientHeight,!1),this.renderer.setPixelRatio(n.pixelRatio??window.devicePixelRatio),this.renderer.setClearColor(0,0),this.renderer.domElement.style.touchAction=`none`,this.cameraController=new t_(this.camera,this.renderer.domElement),this.starLayer=new ev(this.scene),this.gridLayer=new Z_(this.scene),this.landscapeLayer=new Q_(this.scene),this.cardinalDirectionLayer=new n_(e),this.constellationBoundaryLayer=new Y_(this.scene,t.boundaries),this.constellationLayer=new X_(this.scene,e,t.catalog,t.lines);let r=(n.assetPath||``).replace(/data\/$/,``);this.skymapLayer=new $_(this.scene,r);let i=n.observer?.lat??this.observer.lat;this.cameraController.setCameraAngles(0,i),this.setLayerVisibility(n.layers??{}),window.addEventListener(`resize`,this.onWindowResize)}start(){if(this.animationFrameId!==null)return;let e=()=>{this.animationFrameId=requestAnimationFrame(e);let t=new J;this.camera.getWorldDirection(t);let n=Math.asin(t.y),{lat:r,lon:i}=this.observer;this.starLayer.update(r,i,this.time),this.gridLayer.update(r,i,this.time),this.landscapeLayer.update(),this.constellationBoundaryLayer.update(r,i,this.time),this.constellationLayer.update(r,i,this.time),this.skymapLayer.update(r,i,this.time,this.camera),this.starLayer.updateUniforms(this.camera.fov,this.camera.aspect),this.constellationBoundaryLayer.updateUniforms(this.camera.fov,this.camera.aspect),this.constellationLayer.updateUniforms(this.camera.fov,this.camera.aspect),this.gridLayer.updateUniforms(this.camera.fov,this.camera.aspect),this.landscapeLayer.updateUniforms(this.camera.fov,this.camera.aspect,n),this.skymapLayer.updateUniforms(this.camera.fov,this.camera.aspect),this.renderer.render(this.scene,this.camera),this.constellationLayer.updateLabels(this.camera,n),this.cardinalDirectionLayer.update(this.camera)};e()}stop(){this.animationFrameId!==null&&(cancelAnimationFrame(this.animationFrameId),this.animationFrameId=null)}setObserver(e,t=this.time){this.observer={...e},this.time=t}setTime(e){this.time=e}setFov(e){this.cameraController.setFov(e)}setFovChangeCallback(e){this.cameraController.setFovCallback(e)}loadStars(e){this.starLayer.loadStars(e)}setLayerVisibility(e){this.layerVisibility={...this.layerVisibility,...e},this.gridLayer.toggleGrids(this.layerVisibility.azimuthalGrid,this.layerVisibility.equatorialGrid),this.landscapeLayer.setVisibility(this.layerVisibility.landscape),this.cardinalDirectionLayer.setVisible(this.layerVisibility.cardinalDirections),this.constellationBoundaryLayer.setVisible(this.layerVisibility.constellationBoundaries),this.constellationLayer.setLandscapeVisible(this.layerVisibility.landscape),this.constellationLayer.setLinesVisible(this.layerVisibility.constellationLines),this.constellationLayer.setLabelsVisible(this.layerVisibility.constellationLabels),this.skymapLayer.setVisibility(this.layerVisibility.skymap)}setAzimuthalGridVisible(e){this.setLayerVisibility({azimuthalGrid:e})}setEquatorialGridVisible(e){this.setLayerVisibility({equatorialGrid:e})}setLandscapeVisible(e){this.setLayerVisibility({landscape:e})}setCardinalDirectionsVisible(e){this.setLayerVisibility({cardinalDirections:e})}setConstellationLinesVisible(e){this.setLayerVisibility({constellationLines:e})}setConstellationLabelsVisible(e){this.setLayerVisibility({constellationLabels:e})}setConstellationBoundariesVisible(e){this.setLayerVisibility({constellationBoundaries:e})}setConstellationsVisible(e){this.setLayerVisibility({constellationLines:e,constellationLabels:e,constellationBoundaries:e})}dispose(){this.stop(),window.removeEventListener(`resize`,this.onWindowResize),this.cameraController.dispose(),this.starLayer.dispose(),this.gridLayer.dispose(),this.landscapeLayer.dispose(),this.constellationBoundaryLayer.dispose(),this.constellationLayer.dispose(),this.skymapLayer.dispose(),this.cardinalDirectionLayer.dispose(),this.renderer.dispose()}onWindowResize=()=>{let e=this.renderer.domElement,t=e.clientWidth,n=e.clientHeight;t===0||n===0||(this.camera.aspect=t/n,this.camera.updateProjectionMatrix(),this.renderer.setSize(t,n,!1))}},rv={lat:37.5665,lon:126.978},iv=`https://nightsky-cdn.starhub.im/`,av=class{renderer;observer;time;disposed=!1;starCatalogManager;catalogManager;linesManager;boundariesManager;constructor(e,t={}){this.observer=t.observer?{...t.observer}:{...rv},this.time=t.time??new Date;let n=t.assetPath??iv;this.starCatalogManager=new ps(n),this.catalogManager=new os(n),this.linesManager=new ss(n),this.boundariesManager=new cs(n),this.renderer=new nv(e,{catalog:this.catalogManager,lines:this.linesManager,boundaries:this.boundariesManager},{layers:t.layers,pixelRatio:t.pixelRatio,observer:this.observer,assetPath:n}),this.renderer.setObserver(this.observer,this.time);let r=typeof t.fov==`number`?t.fov:185;this.renderer.setFov(r)}start(){this.renderer.start()}stop(){this.renderer.stop()}setObserver(e,t=this.time){this.observer={...e},this.time=t,this.renderer.setObserver(this.observer,this.time)}setLocation(e,t){this.setObserver({lat:e,lon:t})}setTime(e){this.time=e,this.renderer.setTime(e)}setFov(e){this.renderer.setFov(e)}setFovChangeCallback(e){this.renderer.setFovChangeCallback(e)}loadStars(e){this.disposed||this.renderer.loadStars(e)}async loadDefaultStarCatalog(){if(this.disposed)return[];try{let e=await this.starCatalogManager.load();return this.disposed||this.loadStars(e),e}catch(e){throw console.error(`Failed to load star catalog:`,e),e}}setLayerVisibility(e){this.renderer.setLayerVisibility(e)}setAzimuthalGridVisible(e){this.renderer.setAzimuthalGridVisible(e)}setEquatorialGridVisible(e){this.renderer.setEquatorialGridVisible(e)}setLandscapeVisible(e){this.renderer.setLandscapeVisible(e)}setCardinalDirectionsVisible(e){this.renderer.setCardinalDirectionsVisible(e)}setConstellationLinesVisible(e){this.renderer.setConstellationLinesVisible(e)}setConstellationLabelsVisible(e){this.renderer.setConstellationLabelsVisible(e)}setConstellationBoundariesVisible(e){this.renderer.setConstellationBoundariesVisible(e)}setSkymapVisible(e){this.renderer.setLayerVisibility({skymap:e})}dispose(){this.disposed=!0,this.renderer.dispose()}},ov=`0.1.23`,sv={class:`sky-container`},cv={key:0},lv={key:1},uv={class:`sidebar-header`},dv={class:`title-with-version`},fv={class:`app-version`},pv={class:`sidebar-content`},mv={class:`control-group top-spacing`},hv={class:`label-header`},gv={class:`value`},_v={class:`control-group`},vv={class:`label-header`},yv={class:`value`},bv={class:`checkbox-grid`},xv={class:`checkbox-label`},Sv={class:`checkbox-label`},Cv={class:`checkbox-label`},wv={class:`checkbox-label`},Tv={class:`checkbox-label`},Ev={class:`checkbox-label`},Dv={class:`checkbox-label`},Ov={class:`checkbox-label`},kv={class:`time-controls`},Av={class:`time-button-groups`},jv={class:`btn-row`},Mv={class:`btn-row`},Nv={class:`btn-row`},Pv=((e,t)=>{let n=e.__vccOpts||e;for(let[e,r]of t)n[e]=r;return n})(Wn({__name:`SkyCanvas`,setup(e){let t=Vt(null),n=as(),r=Vt(!1),i=null,a=e=>{i=e,e.setFovChangeCallback(e=>{n.updateFov(e)}),e.start()};ar(()=>{if(!t.value)return;let e=new av(t.value,{observer:{lat:n.lat,lon:n.lon},time:n.currentTime,fov:n.fov,layers:{azimuthalGrid:n.showAzimuthalGrid,equatorialGrid:n.showEquatorialGrid,landscape:n.showLandscape,cardinalDirections:n.showCardinalDirections,constellationLines:n.showConstellationLines,constellationLabels:n.showConstellationLabels,constellationBoundaries:n.showConstellationBoundaries,skymap:n.showSkymap},assetPath:`https://nightsky-cdn.starhub.im/`});a(e),e.loadDefaultStarCatalog().catch(()=>{})}),cr(()=>{i&&=(i.dispose(),null)}),In(()=>[n.lat,n.lon,n.currentTime],([e,t,n])=>{i&&i.setObserver({lat:e,lon:t},n)},{deep:!0}),In(()=>n.fov,e=>{i&&i.setFov(e)}),In(()=>[n.showAzimuthalGrid,n.showEquatorialGrid],([e,t])=>{i&&i.setLayerVisibility({azimuthalGrid:e,equatorialGrid:t})}),In(()=>n.showLandscape,e=>{i&&i.setLandscapeVisible(e)}),In(()=>n.showCardinalDirections,e=>{i&&i.setCardinalDirectionsVisible(e)}),In(()=>n.showSkymap,e=>{i&&i.setSkymapVisible(e)}),In(()=>[n.showConstellationLines,n.showConstellationLabels,n.showConstellationBoundaries],([e,t,n])=>{i&&i.setLayerVisibility({constellationLines:e,constellationLabels:t,constellationBoundaries:n})});let o=e=>{let t=new Date(n.currentTime.getTime()+e*36e5);n.updateTime(t)};return(e,i)=>(Pi(),zi(`div`,sv,[U(`button`,{class:`mobile-toggle-btn`,onClick:i[0]||=e=>r.value=!r.value,"aria-label":`Toggle settings`},[r.value?(Pi(),zi(`span`,lv,`✕`)):(Pi(),zi(`span`,cv,`⚙️`))]),r.value?(Pi(),zi(`div`,{key:0,class:`mobile-backdrop`,onClick:i[1]||=e=>r.value=!1})):Xi(``,!0),U(`div`,{class:I([`controls-sidebar`,{"is-open":r.value}])},[U(`div`,uv,[U(`div`,dv,[i[20]||=U(`h3`,null,`Starhub Nightsky`,-1),U(`span`,fv,`v`+he(Wt(ov)),1)]),U(`button`,{class:`close-btn`,onClick:i[2]||=e=>r.value=!1},`✕`)]),U(`div`,pv,[U(`div`,mv,[U(`label`,null,[U(`div`,hv,[i[21]||=U(`span`,null,`시야각(확대)`,-1),U(`span`,gv,he(Wt(n).fov.toFixed(2))+`°`,1)]),kn(U(`input`,{type:`range`,min:`10`,max:`185`,"onUpdate:modelValue":i[3]||=e=>Wt(n).fov=e,class:`wide-range`},null,512),[[ho,Wt(n).fov,void 0,{number:!0}]])])]),U(`div`,_v,[U(`label`,null,[U(`div`,vv,[i[22]||=U(`span`,null,`위도`,-1),U(`span`,yv,he(Wt(n).lat.toFixed(2))+`°`,1)]),kn(U(`input`,{type:`range`,min:`-90`,max:`90`,step:`0.1`,"onUpdate:modelValue":i[4]||=e=>Wt(n).lat=e,class:`wide-range`},null,512),[[ho,Wt(n).lat,void 0,{number:!0}]])])]),U(`div`,bv,[U(`label`,xv,[kn(U(`input`,{type:`checkbox`,"onUpdate:modelValue":i[5]||=e=>Wt(n).showAzimuthalGrid=e},null,512),[[go,Wt(n).showAzimuthalGrid]]),i[23]||=U(`span`,null,`방위좌표`,-1)]),U(`label`,Sv,[kn(U(`input`,{type:`checkbox`,"onUpdate:modelValue":i[6]||=e=>Wt(n).showEquatorialGrid=e},null,512),[[go,Wt(n).showEquatorialGrid]]),i[24]||=U(`span`,null,`적도좌표`,-1)]),U(`label`,Cv,[kn(U(`input`,{type:`checkbox`,"onUpdate:modelValue":i[7]||=e=>Wt(n).showLandscape=e},null,512),[[go,Wt(n).showLandscape]]),i[25]||=U(`span`,null,`지면`,-1)]),U(`label`,wv,[kn(U(`input`,{type:`checkbox`,"onUpdate:modelValue":i[8]||=e=>Wt(n).showCardinalDirections=e},null,512),[[go,Wt(n).showCardinalDirections]]),i[26]||=U(`span`,null,`방위값`,-1)]),U(`label`,Tv,[kn(U(`input`,{type:`checkbox`,"onUpdate:modelValue":i[9]||=e=>Wt(n).showConstellationLines=e},null,512),[[go,Wt(n).showConstellationLines]]),i[27]||=U(`span`,null,`별자리 선`,-1)]),U(`label`,Ev,[kn(U(`input`,{type:`checkbox`,"onUpdate:modelValue":i[10]||=e=>Wt(n).showConstellationLabels=e},null,512),[[go,Wt(n).showConstellationLabels]]),i[28]||=U(`span`,null,`명칭`,-1)]),U(`label`,Dv,[kn(U(`input`,{type:`checkbox`,"onUpdate:modelValue":i[11]||=e=>Wt(n).showConstellationBoundaries=e},null,512),[[go,Wt(n).showConstellationBoundaries]]),i[29]||=U(`span`,null,`경계선`,-1)]),U(`label`,Ov,[kn(U(`input`,{type:`checkbox`,"onUpdate:modelValue":i[12]||=e=>Wt(n).showSkymap=e},null,512),[[go,Wt(n).showSkymap]]),i[30]||=U(`span`,null,`성도 배경`,-1)])]),U(`div`,kv,[i[31]||=U(`div`,{class:`time-header`},`시간 이동`,-1),U(`div`,Av,[U(`div`,jv,[U(`button`,{class:`minus`,onClick:i[13]||=e=>o(-1)},`-1h`),U(`button`,{class:`plus`,onClick:i[14]||=e=>o(1)},`+1h`)]),U(`div`,Mv,[U(`button`,{class:`minus`,onClick:i[15]||=e=>o(-24)},`-1d`),U(`button`,{class:`plus`,onClick:i[16]||=e=>o(24)},`+1d`)]),U(`div`,Nv,[U(`button`,{class:`minus`,onClick:i[17]||=e=>o(-720)},`-1m`),U(`button`,{class:`plus`,onClick:i[18]||=e=>o(720)},`+1m`)])])]),i[32]||=U(`div`,{class:`sidebar-footer`},` Created by Ji Yong ho `,-1)])],2),U(`div`,{class:`sky-canvas-wrapper`,onClick:i[19]||=e=>r.value=!1},[U(`canvas`,{ref_key:`canvasRef`,ref:t,class:`sky-canvas`},null,512)])]))}}),[[`__scopeId`,`data-v-81a9237c`]]),Fv=Co(Wn({__name:`App`,setup(e){return(e,t)=>(Pi(),Bi(Pv))}})),Iv=Wo();Fv.use(Iv),Fv.mount(`#app`);