...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function sm(e,t,n){let r=new Float32Array(qp),i=new J(0,1,0);return new Vf({name:`SphericalGaussianBlur`,defines:{n:qp,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:um(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function cm(){return new Vf({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:um(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function lm(){return new Vf({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:um(),fragmentShader:`
	...
	`}var dm=class extends Gl{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1};this.texture=new Df([n,n,n,n,n,n]),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
      ...
      `,transparent:!0,depthWrite:!1})}},L_=class{scene;canvas;linePoints=[];constellations=[];lineGeometry;lineMaterial;lineSegments;overlay;labels=[];parentElement=null;labelsVisible=!0;landscapeVisible=!0;catalogManager;linesManager;currentOpacity=0;targetOpacity=0;fadeSpeed=.03;labelFadeDurationMs=500;isDataLoading=!1;constructor(e,t,n,r){this.scene=e,this.canvas=t,this.catalogManager=n,this.linesManager=r,this.lineGeometry=new wd,this.lineMaterial=this.createLineMaterial();let i=t.parentElement?.querySelector(`#starhub-constellation-labels`);i?(this.overlay=i,this.overlay.innerHTML=``):(this.overlay=document.createElement(`div`),this.overlay.id=`starhub-constellation-labels`,this.overlay.setAttribute(`aria-hidden`,`true`),this.applyOverlayStyle(),this.mountOverlay()),this.lineSegments=new vf(this.lineGeometry,this.lineMaterial),this.lineSegments.frustumCulled=!1,this.lineSegments.renderOrder=6,this.lineSegments.visible=!1,this.scene.add(this.lineSegments)}update(e,t,n){this.updateAnimation(),this.constellations.length>0&&(this.updateLines(e,t,n),this.updateLabelPositions(e,t,n))}async loadData(){if(!(this.isDataLoading||this.constellations.length>0)){this.isDataLoading=!0;try{let[e,t]=await Promise.all([this.catalogManager.load(),this.linesManager.load()]),n=this.catalogManager.buildDefinitions(e,t);this.setConstellations(n)}catch(e){console.error(`Failed to load constellation data:`,e)}finally{this.isDataLoading=!1}}}setConstellations(e){this.constellations=[...e],this.rebuildGeometry(),this.rebuildLabels()}updateLabels(e,t){if(!this.parentElement||this.labels.length===0)return;this.overlay.style.display=`block`;let n=this.overlay.getBoundingClientRect();if(n.width<=0||n.height<=0)return;e.updateMatrixWorld(!0);let r=e.quaternion.clone().invert(),i=1/Math.tan(Tl.degToRad(e.fov)/4),a=performance.now();for(let o of this.labels){if(o.worldPosition.lengthSq()<1)continue;let s=o.worldPosition.y<0,c=o.worldPosition.clone().applyQuaternion(r).normalize(),l=1-this.clamp((c.z-.5)/.35,0,1),u=1-c.z,d=u>.03,f=d?c.x/u*i/e.aspect:0,p=d?c.y/u*i:0,m=(f*.5+.5)*n.width,h=(-p*.5+.5)*n.height,g=d&&m>=-80&&m<=n.width+80&&h>=-80&&h<=n.height+80,_=this.landscapeVisible&&t>=0&&s;this.labelsVisible&&!_&&g?(o.hiddenSince=null,o.lastScreenX=m,o.lastScreenY=h,o.hasScreenPosition=!0,this.showLabel(o,m,h,l)):(o.hiddenSince===null&&(o.hiddenSince=a),a-o.hiddenSince<this.labelFadeDurationMs&&o.hasScreenPosition&&d?(this.showLabel(o,m,h,0),o.lastScreenX=m,o.lastScreenY=h):this.hideLabel(o))}}updateUniforms(e,t){this.lineMaterial.uniforms.fov.value=e,this.lineMaterial.uniforms.aspect.value=t}setLinesVisible(e){this.targetOpacity=e?.8:0,e&&this.loadData()}setLabelsVisible(e){this.labelsVisible=e,e&&this.loadData()}setLandscapeVisible(e){this.landscapeVisible=e}dispose(){this.scene.remove(this.lineSegments),this.lineGeometry.dispose(),this.lineMaterial.dispose();let e=document.getElementById(`starhub-constellation-labels`);e&&e.remove(),this.labels.length=0}updateAnimation(){let e=this.targetOpacity-this.currentOpacity;Math.abs(e)>.001?(this.currentOpacity+=Math.sign(e)*Math.min(Math.abs(e),this.fadeSpeed),this.lineMaterial.uniforms.opacity.value=this.currentOpacity,this.currentOpacity>0&&!this.lineSegments.visible&&(this.lineSegments.visible=!0)):(this.currentOpacity=this.targetOpacity,this.lineMaterial.uniforms.opacity.value=this.targetOpacity,this.currentOpacity<=0&&(this.lineSegments.visible=!1))}rebuildGeometry(){this.linePoints.length=0;for(let e of this.constellations)for(let t of e.lines)for(let e=0;e<t.length-1;e++){let[n,r]=t[e],[i,a]=t[e+1];this.linePoints.push({ra:n,dec:r},{ra:i,dec:a})}this.linePoints.length!==0&&this.lineGeometry.setAttribute(`position`,new ld(new Float32Array(this.linePoints.length*3),3))}updateLines(e,t,n){if(!this.lineSegments.visible||this.linePoints.length===0)return;let r=this.lineGeometry.attributes.position,i=r.array;if(!(i.length<this.linePoints.length*3)){for(let r=0;r<this.linePoints.length;r++){let a=this.linePoints[r],o=this.equatorialToWorld(a.ra,a.dec,e,t,n,996);i[r*3]=o.x,i[r*3+1]=o.y,i[r*3+2]=o.z}r.needsUpdate=!0}}updateLabelPositions(e,t,n){for(let r of this.labels){let[i,a]=r.definition.label,{az:o,alt:s}=F_(i,a,e,t,n);r.worldPosition.copy(this.azAltToWorld(o,s,997))}}equatorialToWorld(e,t,n,r,i,a){let{az:o,alt:s}=F_(e,t,n,r,i);return this.azAltToWorld(o,s,a)}azAltToWorld(e,t,n){let r=Tl.degToRad(t),i=Tl.degToRad(e);return new J(n*Math.cos(r)*Math.sin(i),n*Math.sin(r),-n*Math.cos(r)*Math.cos(i))}createLineMaterial(){return new Vf({uniforms:{color:{value:new Z(6268884)},opacity:{value:0},fov:{value:60},aspect:{value:1}},vertexShader:`
        uniform float fov;
        uniform float aspect;
        varying vec3 vDir;
        void main() {
    ...
    `,transparent:!0,depthWrite:!1,blending:2})}createStarsMesh(){this.starsPoints&&(this.scene.remove(this.starsPoints),this.starsGeometry?.dispose()),this.starsGeometry=new wd;let e=new Float32Array(this.starsData.length*3),t=new Float32Array(this.starsData.length);for(let e=0;e<this.starsData.length;e++)t[e]=this.starsData[e].mag;this.starsGeometry.setAttribute(`position`,new ld(e,3)),this.starsGeometry.setAttribute(`magnitude`,new ld(t,1)),this.starsPoints=new Tf(this.starsGeometry,this.starsMaterial),this.starsPoints.renderOrder=20,this.scene.add(this.starsPoints)}updateUniforms(e,t){this.starsMaterial&&(this.starsMaterial.uniforms.fov.value=e,this.starsMaterial.uniforms.aspect.value=t)}update(e,t,n){if(!this.starsGeometry||this.starsData.length===0)return;let r=this.starsGeometry.attributes.position.array,i=1e3;for(let a=0;a<this.starsData.length;a++){let o=this.starsData[a],{az:s,alt:c}=F_(o.ra,o.dec,e,t,n),l=c*Math.PI/180,u=s*Math.PI/180,d=i*Math.sin(l),f=-i*Math.cos(l)*Math.cos(u),p=i*Math.cos(l)*Math.sin(u);r[a*3]=p,r[a*3+1]=d,r[a*3+2]=f}this.starsGeometry.attributes.position.needsUpdate=!0}dispose(){this.starsPoints&&this.scene.remove(this.starsPoints),this.starsGeometry?.dispose(),this.starsMaterial?.dispose()}},V_={azimuthalGrid:!1,equatorialGrid:!0,landscape:!0,cardinalDirections:!0,constellationLines:!0,constellationLabels:!0,constellationBoundaries:!1},H_=class{scene;camera;renderer;cameraController;starLayer;gridLayer;landscapeLayer;cardinalDirectionLayer;constellationBoundaryLayer;constellationLayer;observer={lat:37.5665,lon:126.978};time=new Date;layerVisibility={...V_};animationFrameId=null;constructor(e,t,n={}){this.scene=new Au,this.scene.background=new Z(594464),this.camera=new mp(185,e.clientWidth/e.clientHeight,.1,2e3),this.camera.position.set(0,0,0),this.renderer=new Jg({canvas:e,antialias:!0}),this.renderer.setSize(e.clientWidth,e.clientHeight),this.renderer.setPixelRatio(n.pixelRatio??window.devicePixelRatio),this.renderer.domElement.style.touchAction=`none`,this.cameraController=new Yg(this.camera,this.renderer.domElement),this.starLayer=new B_(this.scene),this.gridLayer=new R_(this.scene),this.landscapeLayer=new z_(this.scene),this.cardinalDirectionLayer=new Xg(e),this.constellationBoundaryLayer=new I_(this.scene,t.boundaries),this.constellationLayer=new L_(this.scene,e,t.catalog,t.lines),this.setLayerVisibility(n.layers??{}),window.addEventListener(`resize`,this.onWindowResize)}start(){if(this.animationFrameId!==null)return;let e=()=>{this.animationFrameId=requestAnimationFrame(e);let t=new J;this.camera.getWorldDirection(t);let n=Math.asin(t.y),{lat:r,lon:i}=this.observer;this.starLayer.update(r,i,this.time),this.gridLayer.update(r,i,this.time),this.landscapeLayer.update(),this.constellationBoundaryLayer.update(r,i,this.time),this.constellationLayer.update(r,i,this.time),this.starLayer.updateUniforms(this.camera.fov,this.camera.aspect),this.constellationBoundaryLayer.updateUniforms(this.camera.fov,this.camera.aspect),this.constellationLayer.updateUniforms(this.camera.fov,this.camera.aspect),this.gridLayer.updateUniforms(this.camera.fov,this.camera.aspect),this.landscapeLayer.updateUniforms(this.camera.fov,this.camera.aspect,n),this.renderer.render(this.scene,this.camera),this.constellationLayer.updateLabels(this.camera,n),this.cardinalDirectionLayer.update(this.camera)};e()}stop(){this.animationFrameId!==null&&(cancelAnimationFrame(this.animationFrameId),this.animationFrameId=null)}setObserver(e,t=this.time){this.observer={...e},this.time=t}setTime(e){this.time=e}setFov(e){this.cameraController.setFov(e)}setFovChangeCallback(e){this.cameraController.setFovCallback(e)}loadStars(e){this.starLayer.loadStars(e)}setLayerVisibility(e){this.layerVisibility={...this.layerVisibility,...e},this.gridLayer.toggleGrids(this.layerVisibility.azimuthalGrid,this.layerVisibility.equatorialGrid),this.landscapeLayer.setVisibility(this.layerVisibility.landscape),this.cardinalDirectionLayer.setVisible(this.layerVisibility.cardinalDirections),this.constellationBoundaryLayer.setVisible(this.layerVisibility.constellationBoundaries),this.constellationLayer.setLandscapeVisible(this.layerVisibility.landscape),this.constellationLayer.setLinesVisible(this.layerVisibility.constellationLines),this.constellationLayer.setLabelsVisible(this.layerVisibility.constellationLabels)}setAzimuthalGridVisible(e){this.setLayerVisibility({azimuthalGrid:e})}setEquatorialGridVisible(e){this.setLayerVisibility({equatorialGrid:e})}setLandscapeVisible(e){this.setLayerVisibility({landscape:e})}setCardinalDirectionsVisible(e){this.setLayerVisibility({cardinalDirections:e})}setConstellationLinesVisible(e){this.setLayerVisibility({constellationLines:e})}setConstellationLabelsVisible(e){this.setLayerVisibility({constellationLabels:e})}setConstellationBoundariesVisible(e){this.setLayerVisibility({constellationBoundaries:e})}setConstellationsVisible(e){this.setLayerVisibility({constellationLines:e,constellationLabels:e,constellationBoundaries:e})}dispose(){this.stop(),window.removeEventListener(`resize`,this.onWindowResize),this.cameraController.dispose(),this.starLayer.dispose(),this.gridLayer.dispose(),this.landscapeLayer.dispose(),this.constellationBoundaryLayer.dispose(),this.constellationLayer.dispose(),this.cardinalDirectionLayer.dispose(),this.renderer.dispose()}onWindowResize=()=>{let e=this.renderer.domElement.parentElement;e&&(this.camera.aspect=e.clientWidth/e.clientHeight,this.camera.updateProjectionMatrix(),this.renderer.setSize(e.clientWidth,e.clientHeight))}},U_={lat:37.5665,lon:126.978},W_=`/assets/data/`,G_=class{renderer;observer;time;disposed=!1;starCatalogManager;catalogManager;linesManager;boundariesManager;constructor(e,t={}){this.observer=t.observer?{...t.observer}:{...U_},this.time=t.time??new Date;let n=t.assetPath??W_;this.starCatalogManager=new fs(n),this.catalogManager=new as(n),this.linesManager=new os(n),this.boundariesManager=new ss(n),this.renderer=new H_(e,{catalog:this.catalogManager,lines:this.linesManager,boundaries:this.boundariesManager},{layers:t.layers,pixelRatio:t.pixelRatio}),this.renderer.setObserver(this.observer,this.time);let r=typeof t.fov==`number`?t.fov:185;this.renderer.setFov(r)}start(){this.renderer.start()}stop(){this.renderer.stop()}setObserver(e,t=this.time){this.observer={...e},this.time=t,this.renderer.setObserver(this.observer,this.time)}setLocation(e,t){this.setObserver({lat:e,lon:t})}setTime(e){this.time=e,this.renderer.setTime(e)}setFov(e){this.renderer.setFov(e)}setFovChangeCallback(e){this.renderer.setFovChangeCallback(e)}loadStars(e){this.disposed||this.renderer.loadStars(e)}async loadDefaultStarCatalog(){if(this.disposed)return[];try{let e=await this.starCatalogManager.load();return this.disposed||this.loadStars(e),e}catch(e){throw console.error(`Failed to load star catalog:`,e),e}}setLayerVisibility(e){this.renderer.setLayerVisibility(e)}setAzimuthalGridVisible(e){this.renderer.setAzimuthalGridVisible(e)}setEquatorialGridVisible(e){this.renderer.setEquatorialGridVisible(e)}setLandscapeVisible(e){this.renderer.setLandscapeVisible(e)}setCardinalDirectionsVisible(e){this.renderer.setCardinalDirectionsVisible(e)}setConstellationLinesVisible(e){this.renderer.setConstellationLinesVisible(e)}setConstellationLabelsVisible(e){this.renderer.setConstellationLabelsVisible(e)}setConstellationBoundariesVisible(e){this.renderer.setConstellationBoundariesVisible(e)}dispose(){this.disposed=!0,this.renderer.dispose()}},K_={class:`sky-container`},q_={class:`controls-sidebar`},J_={class:`checkbox-label`},Y_={class:`checkbox-label`},X_={class:`checkbox-label`},Z_={class:`checkbox-label`},Q_={class:`checkbox-label`},$_={class:`checkbox-label`},ev={class:`checkbox-label`},tv={class:`time-controls`},nv={class:`sky-canvas-wrapper`},rv=((e,t)=>{let n=e.__vccOpts||e;for(let[e,r]of t)n[e]=r;return n})(Wn({__name:`SkyCanvas`,setup(e){let t=Vt(null),n=is(),r=null,i=e=>{r=e,e.setFovChangeCallback(e=>{n.updateFov(e)}),e.start()};ar(()=>{if(!t.value)return;let e=new G_(t.value,{observer:{lat:n.lat,lon:n.lon},time:n.currentTime,fov:n.fov,layers:{azimuthalGrid:n.showAzimuthalGrid,equatorialGrid:n.showEquatorialGrid,landscape:n.showLandscape,cardinalDirections:n.showCardinalDirections,constellationLines:n.showConstellationLines,constellationLabels:n.showConstellationLabels,constellationBoundaries:n.showConstellationBoundaries},assetPath:`/starhub-nightsky/assets/data/`});i(e),e.loadDefaultStarCatalog().catch(()=>{})}),cr(()=>{r&&=(r.dispose(),null)}),In(()=>[n.lat,n.lon,n.currentTime],([e,t,n])=>{r&&r.setObserver({lat:e,lon:t},n)},{deep:!0}),In(()=>n.fov,e=>{r&&r.setFov(e)}),In(()=>[n.showAzimuthalGrid,n.showEquatorialGrid],([e,t])=>{r&&r.setLayerVisibility({azimuthalGrid:e,equatorialGrid:t})}),In(()=>n.showLandscape,e=>{r&&r.setLandscapeVisible(e)}),In(()=>n.showCardinalDirections,e=>{r&&r.setCardinalDirectionsVisible(e)}),In(()=>[n.showConstellationLines,n.showConstellationLabels,n.showConstellationBoundaries],([e,t,n])=>{r&&r.setLayerVisibility({constellationLines:e,constellationLabels:t,constellationBoundaries:n})});let a=e=>{let t=new Date(n.currentTime.getTime()+e*36e5);n.updateTime(t)};return(e,r)=>(Pi(),zi(`div`,K_,[U(`div`,q_,[r[20]||=U(`h3`,null,`Starhub Nightsky`,-1),U(`label`,null,[Yi(` 시야각(확대): `+he(Wt(n).fov)+`° `,1),kn(U(`input`,{type:`range`,min:`10`,max:`185`,"onUpdate:modelValue":r[0]||=e=>Wt(n).fov=e},null,512),[[mo,Wt(n).fov,void 0,{number:!0}]])]),U(`label`,null,[Yi(` 위도: `+he(Wt(n).lat.toFixed(2))+`° `,1),kn(U(`input`,{type:`range`,min:`-90`,max:`90`,step:`0.1`,"onUpdate:modelValue":r[1]||=e=>Wt(n).lat=e},null,512),[[mo,Wt(n).lat,void 0,{number:!0}]])]),U(`label`,J_,[kn(U(`input`,{type:`checkbox`,"onUpdate:modelValue":r[2]||=e=>Wt(n).showAzimuthalGrid=e},null,512),[[ho,Wt(n).showAzimuthalGrid]]),r[12]||=Yi(` 방위좌표 격자 표시 `,-1)]),U(`label`,Y_,[kn(U(`input`,{type:`checkbox`,"onUpdate:modelValue":r[3]||=e=>Wt(n).showEquatorialGrid=e},null,512),[[ho,Wt(n).showEquatorialGrid]]),r[13]||=Yi(` 적도좌표 격자 표시 `,-1)]),U(`label`,X_,[kn(U(`input`,{type:`checkbox`,"onUpdate:modelValue":r[4]||=e=>Wt(n).showLandscape=e},null,512),[[ho,Wt(n).showLandscape]]),r[14]||=Yi(` 지면 표시 `,-1)]),U(`label`,Z_,[kn(U(`input`,{type:`checkbox`,"onUpdate:modelValue":r[5]||=e=>Wt(n).showCardinalDirections=e},null,512),[[ho,Wt(n).showCardinalDirections]]),r[15]||=Yi(` 동서남북 표시 `,-1)]),U(`label`,Q_,[kn(U(`input`,{type:`checkbox`,"onUpdate:modelValue":r[6]||=e=>Wt(n).showConstellationLines=e},null,512),[[ho,Wt(n).showConstellationLines]]),r[16]||=Yi(` 별자리 선 표시 `,-1)]),U(`label`,$_,[kn(U(`input`,{type:`checkbox`,"onUpdate:modelValue":r[7]||=e=>Wt(n).showConstellationLabels=e},null,512),[[ho,Wt(n).showConstellationLabels]]),r[17]||=Yi(` 별자리 이름 표시 `,-1)]),U(`label`,ev,[kn(U(`input`,{type:`checkbox`,"onUpdate:modelValue":r[8]||=e=>Wt(n).showConstellationBoundaries=e},null,512),[[ho,Wt(n).showConstellationBoundaries]]),r[18]||=Yi(` 별자리 경계선 표시 `,-1)]),U(`div`,tv,[r[19]||=Yi(` 시간 이동: `,-1),U(`button`,{onClick:r[9]||=e=>a(1)},`+1시간`),U(`button`,{onClick:r[10]||=e=>a(24)},`+1일`),U(`button`,{onClick:r[11]||=e=>a(720)},`+1개월`)])]),U(`div`,nv,[U(`canvas`,{ref_key:`canvasRef`,ref:t,class:`sky-canvas`},null,512)])]))}}),[[`__scopeId`,`data-v-76fe7e27`]]),iv=So(Wn({__name:`App`,setup(e){return(e,t)=>(Pi(),Bi(rv))}})),av=Uo();iv.use(av),iv.mount(`#app`);